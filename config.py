...
def arg_parse():
    ...
    # parser.add_argument('--save_path', nargs='?', default='./Checkpoints/pretrained_models/pretrained_motasg_foundation.pt', help='save path for model. (default: pretrained_motasg_foundation.pt)')
    ...
    # parser.add_argument('--train_save_path', nargs='?', default='./MOTASG_Results/DepMap/MOTASG_Class/epoch_10_best/epoch_model_3.pt', help='Path to save the trained model.')
    ...
    parser.add_argument('--output_result_dir', type=str, default='./QA_Results/', help='Output directory for GALAX task.')
